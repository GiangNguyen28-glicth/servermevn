...
const at_strategy_1 = require("./JWT/at.strategy");
...
UserModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([{ name: password_reset_1.PasswordReset.name, schema: password_reset_1.PasswordResetSchema }]),
            jwt_1.JwtModule.register({})
        ],
        controllers: [user_controller_1.UserController],
        providers: [user_service_1.UserService, at_strategy_1.AtStrategy, rt_strategy_1.RtStrategy, solve_excel_1.ExcelFile],
